<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" id="formactualiza" action="<?php echo constant("URL") ?>Main/agregarPersona" method="POST"> 
                <div class="col-md-12" id="conten"> 
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="input-group"> 
                            <input type="tel" class="form-control"  name="telefono"  placeholder="Ingresa el telefono" required> 
                        </div> 
                    </div> 
                    <div class="form-group"> 
      ...
      <div class="modal-footer"> 
        ...
        <input type="submit" name="submit" class="btn btn-success btn-md" form="formactualiza" value="Enviar"> 
      </div> 
    </div> 
  </div> 
</div>
